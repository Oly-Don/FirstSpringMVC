package com.oly.controller.caserunner;


import com.oly.entity.RunnerVo;
...
public class SingerRunnerController {
    ...
    public String singlecase(Model model) {
        looger.info("com.oly.controller.caserunner.SingerRunnerController.singlecase");
        /*
     默认选中项
         */
    ...
    public void runCase(
        ...
        looger.info("com.oly.controller.caserunner.SingerRunnerController.runCase");
        if (vo != null) {
